        ...
        <div>
            ...
            <div class="settings form">
                ...
                <h2 class="title">Update Profile</h2>
                    ...
                    <label for="profile-img" class="ctn"><i class="fa fa-upload"></i>Upload picture</label>
                    <input class="profile-img" type="file" style={{visibility: "hidden", display: "none"}} id="profile-img" />
                    <div class="input-fields">
                        <i class="fas fa-user"></i>
                        <input class="name" type="username" placeholder="*Username" required />
                    </div>
                    <div class="input-fields">
                    ...
                    <button class="ctn" type="button" value="submit">Save changes</button>
                </form>
            </div>
